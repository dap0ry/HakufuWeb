...
// cache instead).
const CACHE_NAME = 'hakufu-shell-v8';
const SHELL_FILES = ['/', '/index.html', '/webapp.js', '/api.js', '/account.js', '/friends.js', '/settings.js', '/reader.js', '/offline-store.js', '/local-library.js', '/cover-extract.js', '/manifest.json'];
