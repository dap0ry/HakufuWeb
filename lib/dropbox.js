...
// Dropbox's OAuth2 flow is structurally the standard one (authorization_code
...
function buildConsentUrl(state) {
  ...
  const params = new URLSearchParams({
    ...
    // Fijado explícitamente en vez de heredar lo que esté configurado en la
    // Dropbox App Console: mínimo privilegio, y coincide con los permisos de
    // App folder configurados para esta app (solo lectura/escritura de
    // contenido, nada de metadata de la cuenta ni de otras carpetas).
